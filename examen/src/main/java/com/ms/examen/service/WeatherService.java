...
public class WeatherService {
    ...
    private String unit;
    private String APIkey = "OXWZnqaHogJarGc2ClSElaARKuCGnybP";
    ...
    public JSONObject getWeather(){
        ...
        Request request = new Request.Builder()
                .url("http://dataservice.accuweather.com/locations/v1/cities/search?apikey="+"&appid="+APIkey+"&q="+getCityName())
                .build();
